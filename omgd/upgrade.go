...
// oldOmcdHomeDir returns the OS specific home directory btcd used prior to
...
func upgradeDBPaths() error {
	...
	oldDbRoot := filepath.Join(oldOmcdHomeDir(), "db")
