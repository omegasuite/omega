...
type txValidator struct {
	...
	utxoView     *viewpoint.UtxoViewpoint
...
func newTxValidator(utxoView *viewpoint.UtxoViewpoint, flags txsparser.ScriptFlags,
...
func ValidateTransactionScripts(tx *btcutil.Tx, utxoView *viewpoint.UtxoViewpoint,
	flags txsparser.ScriptFlags, sigCache *txscript.SigCache,
	...
	segwitActive := flags&txsparser.ScriptVerifyWitness == txsparser.ScriptVerifyWitness
...
func checkBlockScripts(block *btcutil.Block, utxoView *viewpoint.UtxoViewpoint,
	scriptFlags txsparser.ScriptFlags, sigCache *txscript.SigCache,
	hashCache *txscript.HashCache) error {

	// First determine if segwit is active according to the scriptFlags. If
	// it isn't then we don't need to interact with the HashCache.
	segwitActive := scriptFlags&txsparser.ScriptVerifyWitness == txsparser.ScriptVerifyWitness
