...
func (msg *MsgGetAddr) OmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// OmcEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr) OmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
