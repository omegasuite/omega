...
func ReadMessageN(r io.Reader, pver uint32, btcnet common.BitcoinNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet common.BitcoinNet) (Message, []byte, error) {
