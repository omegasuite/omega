...
const (
	CommitteeSize				= 3		// 3
	MinerGap					= 3	// 3		// a miner must wait between to candidacies. should >= CommitteeSize - 1

	TimeGap						= 2000		// time gap between two signed blocks generated by the same miner
