...
const (
	CommitteeSize				= 7
	CommitteeSigs				= 5			// signature required for a signed block
	POWRotate					= 4			// rotation upon a POW block
	MinerGap					= 7			// a miner must wait between to candidacies. should >= CommitteeSize - 1

	TimeGap						= 60		// time gap between two signed blocks generated by the same miner
