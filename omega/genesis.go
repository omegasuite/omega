...
var genesisCoinbaseTx = wire.MsgTx{
	...
	SignatureScripts: [][]byte { []byte{
		0xa6, 0x7f, 0xb2, 0x8b, 0x21, 0xb1, 0x0f, 0x79,
		0x2a, 0x67, 0xd0, 0xbc, 0x4a, 0x19, 0x8d, 0x5a,
		0x4f, 0x0d, 0xa2, 0xb5, 0x75, 0x4f, 0x8c, 0x5b,
		0x31, 0x59, 0x76, 0xe4, 0xef, 0xea, 0x2e, 0xda,
	} },
	LockTime: 0,
}
...
var GenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:  time.Unix(0x5df43dc7, 0), //
//		Bits:       0x1f00ffff,               //
		Nonce:      54177,
	},
...
var GenesisHash = []chainhash.Hash{
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x67, 0x4b, 0xcf, 0x38, 0xbe, 0x2c, 0x75, 0x83,
		0xf0, 0xb2, 0x95, 0x89, 0x06, 0xfd, 0xa5, 0x50,
		0x32, 0x72, 0x7d, 0xa6, 0x76, 0x9d, 0x89, 0xaf,
		0x7b, 0x5e, 0x6f, 0x4e, 0x24, 0xcd, 0x00, 0x00,
	},
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x2d, 0x38, 0xe7, 0x7e, 0x0d, 0x4d, 0x32, 0x1c,
		0x2d, 0xec, 0xae, 0x68, 0x7b, 0xbc, 0x3e, 0x34,
		0xe4, 0x7d, 0x72, 0xe2, 0x4d, 0x7c, 0x08, 0xe8,
		0xef, 0xb7, 0x67, 0xf2, 0x91, 0x7e, 0x00, 0x00,
	},
}
...
var RegTestGenesisHash = []chainhash.Hash{
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x90, 0x1c, 0x4f, 0x96, 0xa3, 0xbe, 0x3e, 0x99,
		0x29, 0x96, 0xad, 0x8e, 0x1f, 0xb7, 0xef, 0x6b,
		0xb3, 0x1d, 0x0a, 0xc6, 0xe7, 0xa9, 0x19, 0x90,
		0x84, 0xec, 0x18, 0x12, 0x3d, 0x4c, 0x41, 0x00,
	},
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x0a, 0x7e, 0x04, 0xb0, 0x29, 0x30, 0xf9, 0x34,
		0xd6, 0x54, 0xaa, 0xea, 0x05, 0x33, 0xd3, 0x0f,
		0x45, 0x00, 0xa5, 0xcc, 0x92, 0x49, 0x37, 0x2a,
		0x90, 0x05, 0x82, 0x7b, 0x53, 0x82, 0x4f, 0x00,
	},
}
...
var RegTestGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:  time.Unix(0x5df43dda, 0), //
//		Bits:       0x1f7fffff,               //
		Nonce:      422,
	},
	Transactions: []*wire.MsgTx{&genesisCoinbaseTx, &genesisInitPolygonTx},
...
var TestNet3GenesisHash = []chainhash.Hash{
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x79, 0x2c, 0x37, 0x05, 0xc8, 0xd4, 0x43, 0xb2,
		0x25, 0xa1, 0xa5, 0x70, 0xa1, 0x75, 0x06, 0x2e,
		0x79, 0xbf, 0xac, 0xde, 0x2c, 0xd3, 0x6a, 0x84,
		0x2b, 0x67, 0xfd, 0x3c, 0xf9, 0xf8, 0x00, 0x00,
	},
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x6d, 0xae, 0x03, 0xf8, 0x7d, 0x3e, 0xa1, 0x51,
		0x7f, 0x94, 0x8f, 0x94, 0x66, 0xb8, 0x06, 0xe2,
		0xc3, 0xd7, 0x00, 0x9d, 0x88, 0xd9, 0x17, 0x86,
		0x61, 0x1b, 0x48, 0xd1, 0x95, 0x58, 0x00, 0x00,
	},
}
...
var SimNetGenesisHash = []chainhash.Hash{
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x3c, 0x20, 0x23, 0x8e, 0x69, 0xca, 0xe5, 0x2f,
		0xf0, 0xda, 0xe2, 0x30, 0x7d, 0x9a, 0x2d, 0x32,
		0x76, 0xe8, 0x3e, 0xc2, 0x7f, 0x9d, 0x32, 0x90,
		0x3e, 0x4d, 0xc4, 0x56, 0xca, 0xb2, 0x37, 0x00,
	},
	[chainhash.HashSize]byte{ // Make go vet happy.
		0x76, 0x70, 0xee, 0x21, 0x24, 0x71, 0x02, 0x28,
		0x77, 0x7c, 0x19, 0x32, 0xb2, 0x85, 0x5f, 0x4a,
		0x02, 0xee, 0x6c, 0xbc, 0x65, 0xe1, 0x5a, 0xc8,
		0xf4, 0xd7, 0xc6, 0xbf, 0xeb, 0xcc, 0x77, 0x00,
	},
}
...
var SimNetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:  time.Unix(0x5df43e01, 0), //
//		Bits:       0x1f7fffff,               //
		Nonce:      1835,
	},
	Transactions: []*wire.MsgTx{&genesisCoinbaseTx, &genesisInitPolygonTx},
...
//	Bits:       SimNetGenesisBlock.Header.Bits,               //
	Nonce:      170,
