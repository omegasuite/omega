...
const (
	...
	BaseEncoding wire.MessageEncoding = 1 << iota
...
func WriteMessageN(w io.Writer, msg wire.Message, pver uint32, btcnet BitcoinNet) (int, error) {
...
func WriteMessage(w io.Writer, msg wire.Message, pver uint32, btcnet BitcoinNet) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg wire.Message, pver uint32,
	btcnet BitcoinNet, encoding wire.MessageEncoding) (int, error) {
...
func ReadMessageN(r io.Reader, pver uint32, btcnet BitcoinNet) (int, wire.Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet BitcoinNet) (wire.Message, []byte, error) {
