...
const (
	...
	BALANCE
	__ORIGIN				// no longer used anymore, but keep the slot to be compatible with EVM
	CALLER
	CALLVALUE
	CALLDATALOAD
	CALLDATASIZE
	...
	CODESIZE
	CODECOPY
	__GASPRICE			// no longer used anymore, but keep the slot to be compatible with EVM
	EXTCODESIZE
	EXTCODECOPY
	RETURNDATASIZE
	RETURNDATACOPY
