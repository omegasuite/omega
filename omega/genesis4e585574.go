...
var InitDefs4e585574 = []token.Definition{
	&token.BorderDef{
...
var polygonToken4e585574 = token.Token{
	TokenType: 3,
...
var testnetPolygonTx4e585574 = wire.MsgTx{
	Version: 0x11,
	TxDef:   InitDefs4e585574,
	TxIn:    []*wire.TxIn{},
	TxOut: []*wire.TxOut{
		{
			Token: polygonToken4e585574,
			PkScript: []byte{
				0x6f, 0xe4, 0xf4, 0x19, 0x2e, 0x40, 0x81, 0x11,
				0xfc, 0xbe, 0xea, 0x9e, 0x19, 0x71, 0x2f, 0x94,
				0x0c, 0xce, 0xfd, 0xb8, 0x2d, 0x41, 0x00, 0x00,
...
var TestNetGenesisMerkleRoot4e585574 = chainhash.Hash{
	0xed, 0xb2, 0xf6, 0x26, 0xa8, 0xa3, 0x97, 0x08,
	0x43, 0x1b, 0x8f, 0xef, 0x99, 0xc3, 0x26, 0x1e,
	0xb6, 0x22, 0x12, 0x85, 0x2f, 0x91, 0x8b, 0xee,
	0xf5, 0x50, 0x76, 0xf5, 0xc3, 0x71, 0xa7, 0x5e,
...
var TestNetGenesisBlock4e585574 = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version:    0x10000,
		PrevBlock:  chainhash.Hash{},
		MerkleRoot: TestNetGenesisMerkleRoot4e585574,
		Timestamp:  time.Unix(0x687590b3, 0),
		Nonce:      620,
	},
	Transactions: []*wire.MsgTx{&testnetcoinbaseTx4e585574, &testnetPolygonTx4e585574},
}

var TestNetGenesisHash4e585574 = []chainhash.Hash{
	chainhash.Hash{
		0x85, 0x65, 0xde, 0xf8, 0xf2, 0xa3, 0x3c, 0xb8,
		0x50, 0x7f, 0x74, 0x40, 0x63, 0xb4, 0x1d, 0x86,
		0xc8, 0x87, 0xac, 0xe1, 0x9c, 0xcb, 0x6a, 0x6f,
		0x38, 0x47, 0x8d, 0xab, 0x24, 0x7c, 0x3b, 0x00,
	},
	chainhash.Hash{
		0x61, 0x9d, 0xe8, 0xb6, 0x88, 0xbc, 0xa8, 0x83,
		0xad, 0xf6, 0x5d, 0x24, 0x3a, 0x98, 0x03, 0x9c,
		0x49, 0x52, 0xb9, 0xb0, 0xf6, 0xc4, 0x24, 0x56,
		0x7c, 0x98, 0x26, 0x77, 0x58, 0x34, 0x06, 0x00,
	},
}

var TestNetGenesisMinerBlock4e585574 = wire.MingingRightBlock{
	Version:   0x10000,
	PrevBlock: chainhash.Hash{},
	BestBlock: TestNetGenesisHash4e585574[0],
	Timestamp: time.Unix(0x687590b3, 0),
	Bits:      0x1f0fffff,
	Nonce:     300,
	Connection: []byte{
